  ...
  locales: {
    root: {
      ...
      themeConfig: {
        ...
        // Load generated sidebars if present; otherwise, fall back to manual sidebar
        // Auto-generated by scripts/update-nav.js -> docs/.vitepress/generated-sidebars.js
        // This allows CI to regenerate sidebars before build.
        sidebar: (function() {
          if (GENERATED_SIDEBARS && GENERATED_SIDEBARS.english) return Object.assign({}, GENERATED_SIDEBARS.english)
          console.warn('Generated sidebars not found, using manual sidebar.')
          return {
            '/guides/': [
              {
    ...
    zh: {
      ...
      themeConfig: {
        ...
        // Load generated sidebars if present; otherwise, fall back to manual sidebar
        sidebar: (function() {
          if (GENERATED_SIDEBARS && GENERATED_SIDEBARS.chinese) return Object.assign({}, GENERATED_SIDEBARS.chinese)
          console.warn('Generated sidebars not found for zh, using manual sidebar.')
          return {
            '/zh/guides/': [
              {
                text: '分步指南',
